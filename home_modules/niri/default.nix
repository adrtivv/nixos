{self, ...}: {
  flake.homeModules.niri = {
    ...
    imports = [
      self.homeModules.dank_material_shell

      self.homeModules.dank_material_shell.niri
    ...
    programs.niri.settings = {
      ...
      input = {
        ...
        # https://github.com/sodiboo/niri-flake/blob/main/docs.md#programsnirisettingsinputwarp-mouse-to-focus
        warp-mouse-to-focus = {
          # https://github.com/sodiboo/niri-flake/blob/main/docs.md#programsnirisettingsinputwarp-mouse-to-focusenable
          enable = true;
        };
      };
